...
- Weekly Reports: Revenue, jobs completed, outstanding payments — every Sunday.

Setup Process:
- Takes 5 minutes via WhatsApp conversation
- No app download required — works entirely through WhatsApp
- No training needed — just text like you'd text a friend
- Crew members don't need to download anything either

Pricing:
- Starter: $79/month — up to 3 crew, scheduling, reminders, invoicing, morning digest, 1 supplier
- Growth: $149/month — up to 10 crew, multiple suppliers, weekly reports, priority support, custom templates (most popular)
- Pro: $299/month — up to 20 crew, multi-location, QuickBooks integration, dedicated onboarding
- All plans: +0.5% on card payments processed. No monthly minimum.
- Free 30-day trial on all plans. No credit card required. Cancel anytime.

Supported Industries:
Residential cleaning, commercial cleaning, landscaping, pool service, mobile auto detailing, mobile pet grooming, pressure washing, pest control, HVAC, handyman services, junk removal, and more.
